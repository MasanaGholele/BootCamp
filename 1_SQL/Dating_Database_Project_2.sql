...
CREATE TABLE my_contacts 
	(
		...
		zip_code INT REFERENCES zip_codes (zip_code) ON DELETE CASCADE, 
...
CREATE TABLE zip_codes
	(
		zip_code INT CHECK (zip_code between 0 and 9999) CONSTRAINT zip_code PRIMARY KEY,
...
VALUES 
	('Tonny','Leon','0680615009','tonny@gmail.com','M','1989/06/13',0001,3,1),
    ('Girly','Ndala','0810615012','girly@gmail.com','F','1991/08/15',6100,1,9),
    ('Joey','Ndlala','0789615078','joey@gmail.com','F','2000/10/04',0002,2,3),
    ('Marrylin','Smith','0696615009','marrylin@gmail.com','F','1988/06/07',0001,2,8),
    ...
    ('Lizzy','Sunny','0830541009','lizzy@gmail.com','F','1976/06/13',0001,3,1),
	('Tom','Smith','0780875909','tom@gmail.com','F','1993/04/17',6100,1,1),
    ('Gugu','Ndaba','0786312012','gugu@gmail.com','F','2000/08/18',0002,3,7),
...
VALUES
	...
	(0006, 'Western Cape', 'Cape Town'),
	(7000, 'Western  Cape', 'Stellenbosch'),
	(0008, 'Northen Cape', 'Namaqualand'),
	(8000, 'Northern Cape', 'Worcester'),
	(0009, 'North West', 'Rusternburg'),
	(9000, 'North West', 'Hartebeespoort'),
	(0010, 'Free State', 'Bethlehem'),
